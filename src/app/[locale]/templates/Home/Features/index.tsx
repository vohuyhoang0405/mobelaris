  ...
  const data = {
    ...
    blocks: {
      "375d226b-dc8c-4f1c-bdb6-89ad274cd195": {
        type: "block",
        settings: {
          image: await import("./images/1.jpeg").then((m) => m.default),
          content:
      ...
      "8f243b2d-a93f-413a-84c3-59a8dd5c308e": {
        type: "block",
        settings: {
          image: await import("./images/2.png").then((m) => m.default),
          content:
      ...
      "5d4642d9-5254-407d-990b-524deb67fcfa": {
        type: "block",
        settings: {
          image: await import("./images/3.png").then((m) => m.default),
          content:
      ...
      "e1868614-edd4-4e18-990c-41b270ac2f25": {
        type: "block",
        settings: {
          image: await import("./images/4.png").then((m) => m.default),
          content:
        ...
        {data.block_order.map((blockid) => {
          ...
          return (
            <li key={blockid} className="flex max-w-xs flex-1 items-start ">
              ...
              />
              <div className="mt-2 ">
                <T ishtml>{block.settings.content}</T>
              </div>
            </li>
          )
        })}
